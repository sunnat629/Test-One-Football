...
import onefootball.com.testonefootball.data.PushItem;
import onefootball.com.testonefootball.data.PushRepository;

public class PushDialogFragment extends BottomSheetDialogFragment implements PushDialog
{
    ...
    public static PushDialogFragment newInstanceTeam(long teamId, String teamName, PushRepository repository)
    {
        final PushDialogFragment dialog = new PushDialogFragment();
    ...
    public void onAttach(Activity activity)
    {
        ...
        dialogListener = activity instanceof PushDialogActionListener ? (PushDialogActionListener) activity : null;
    }
    ...
    private void setupPrimaryButton(Dialog dialog)
    {
        ...
        primaryButton.setOnClickListener(v -> {
            ...
            {
                dialogListener.onPushDialogPositiveClick(PushDialogFragment.this);
            }
            dismiss();
        });
    }
